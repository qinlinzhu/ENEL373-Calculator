...
entity bin_to_bcd is
    generic (
        ...
        NUM_SIZE : integer := 25; --! Length of binary input
...
begin
    ...
    process (clock, reset)
        variable bin_reg : std_logic_vector (bits - 2 downto 0); -- 10 down to 0
            ...
            case state is
                ...
                when CONVERT =>
                    if count < bits-1 then
                        ...
                        bcd_reg := bcd_reg(digits * 4 - 2 downto 0) & bin_reg(bits - 2);
                        bin_reg := bin_reg(bits - 3 downto 0) & '0';
